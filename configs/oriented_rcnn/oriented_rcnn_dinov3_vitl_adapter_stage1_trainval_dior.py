...
# (oriented_rcnn_dinov3_vitl_adapter_stage2_trainval_dior.py) which loads this
# checkpoint, unfreezes the ViT, and fine-tunes end-to-end at a low backbone LR.
#
# Usage:
#   bash scripts/orcnn_vitl_adapter_trainval.sh          # runs stage1 then stage2
#   # or stage 1 only:
#   CUDA_VISIBLE_DEVICES=0,1,2,3 NUM_GPUS=4 STAGE=1 bash scripts/orcnn_vitl_adapter_trainval.sh
# =============================================================================

_base_ = ['_oriented_rcnn_dinov3_vitl_adapter_base_trainval_dior.py']
...
# lr is calibrated for the ViT-L recipe used by orcnn_vitl_adapter_trainval.sh:
