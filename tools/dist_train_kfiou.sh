...
#
# Usage:
#   bash tools/dist_train_kfiou.sh
#
...
# Examples:
#   bash tools/dist_train_kfiou.sh
#   CUDA_VISIBLE_DEVICES=0,1 NUM_GPUS=2 bash tools/dist_train_kfiou.sh
#   RESUME=work_dirs/.../latest.pth bash tools/dist_train_kfiou.sh
# =============================================================================
