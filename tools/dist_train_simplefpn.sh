...
#
# Usage:
#   bash tools/dist_train_simplefpn.sh
#
...
# Examples:
#   bash tools/dist_train_simplefpn.sh
#   CUDA_VISIBLE_DEVICES=0,1 NUM_GPUS=2 bash tools/dist_train_simplefpn.sh
#   RESUME=work_dirs/.../latest.pth bash tools/dist_train_simplefpn.sh
# =============================================================================
