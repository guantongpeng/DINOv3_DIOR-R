...
#
# Usage:
#   bash tools/dist_train_trainval.sh
#
...
# Examples:
#   bash tools/dist_train_trainval.sh
#   CUDA_VISIBLE_DEVICES=0,1 NUM_GPUS=2 bash tools/dist_train_trainval.sh
#   EVAL_INTERVAL=5 bash tools/dist_train_trainval.sh     # less frequent (cheaper) eval
#   RESUME=work_dirs/.../latest.pth bash tools/dist_train_trainval.sh
# =============================================================================
