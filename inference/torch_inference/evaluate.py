"""Gather sharded results and evaluate DOTA-style rotated mAP (pure PyTorch)."""
...
def parse_args():
    ...
    p.add_argument('--results-dir', default='inference/torch_inference/results')
...
def main():
    ...
    mean_ap, results = eval_rbbox_map(det_results, annotations, iou_thr=args.iou_thr,
                                      use_07_metric=True, classes=list(dior_data.CLASSES))
