...
#
# Usage:
#   bash scripts/orcnn_vitb_adapter_trainval.sh                      # stage1 -> stage2
#   STAGE=1 bash scripts/orcnn_vitb_adapter_trainval.sh              # stage 1 only
#   STAGE=2 STAGE1_CKPT=work_dirs/.../best_mAP_epoch_30.pth \
#       bash scripts/orcnn_vitb_adapter_trainval.sh                  # stage 2 only
#   STAGE=1 RESUME=1 WORK_DIR=work_dirs/.../oriented_rcnn_dinov3_vitb_adapter_trainval_dior_<ts> \
#       bash scripts/orcnn_vitb_adapter_trainval.sh                  # resume interrupted stage 1
#
...
# ----------------------------- configuration --------------------------------
CONFIG_S1='configs/oriented_rcnn/oriented_rcnn_dinov3_vitb_adapter_stage1_trainval_dior.py'
CONFIG_S2='configs/oriented_rcnn/oriented_rcnn_dinov3_vitb_adapter_stage2_trainval_dior.py'
...
WORK_DIR=${WORK_DIR:-"work_dirs/oriented_rcnn_dinov3_vitb_adapter_trainval_dior_$(date +%Y%m%d_%H%M%S)"}
