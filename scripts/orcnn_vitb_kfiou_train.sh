...
# =============================================================================
# Config: configs/oriented_rcnn/oriented_rcnn_dinov3_vitb_simplefpn_kfiou_train_dior.py
#
...
#
# Usage:
#   bash scripts/orcnn_vitb_kfiou_train.sh
#
...
# Examples:
#   bash scripts/orcnn_vitb_kfiou_train.sh
#   CUDA_VISIBLE_DEVICES=0,1 bash scripts/orcnn_vitb_kfiou_train.sh
#   RESUME=work_dirs/.../latest.pth bash scripts/orcnn_vitb_kfiou_train.sh
# =============================================================================
...
WORK_DIR=${WORK_DIR:-"work_dirs/oriented_rcnn_dinov3_vitb_simplefpn_kfiou_train_dior_$(date +%Y%m%d_%H%M%S)"}
...
echo "  CONFIG='configs/oriented_rcnn/oriented_rcnn_dinov3_vitb_simplefpn_kfiou_train_dior.py' \\"
