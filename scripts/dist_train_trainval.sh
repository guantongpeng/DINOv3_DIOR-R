...
#
# Usage:
#   bash scripts/dist_train_trainval.sh
#
...
# Examples:
#   bash scripts/dist_train_trainval.sh
#   CUDA_VISIBLE_DEVICES=0,1 bash scripts/dist_train_trainval.sh
#   EVAL_INTERVAL=5 bash scripts/dist_train_trainval.sh     # less frequent (cheaper) eval
#   RESUME=work_dirs/.../latest.pth bash scripts/dist_train_trainval.sh
# =============================================================================
