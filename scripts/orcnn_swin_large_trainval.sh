...
# Examples:
#   bash scripts/orcnn_swin_large_trainval.sh
#   CUDA_VISIBLE_DEVICES=0,1 SAMPLES_PER_GPU=2 bash scripts/orcnn_swin_large_trainval.sh
#   EVAL_INTERVAL=5 bash scripts/orcnn_swin_large_trainval.sh   # cheaper eval
#   RESUME=work_dirs/.../latest.pth bash scripts/orcnn_swin_large_trainval.sh
# =============================================================================
