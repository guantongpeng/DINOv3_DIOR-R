...
# Examples:
#   bash scripts/dist_train_trainval_vitb_fpn.sh
#   CUDA_VISIBLE_DEVICES=0,1 SAMPLES_PER_GPU=8 bash scripts/dist_train_trainval_vitb_fpn.sh
#   EVAL_INTERVAL=5 bash scripts/dist_train_trainval_vitb_fpn.sh     # less frequent (cheaper) eval
#   RESUME=work_dirs/.../latest.pth bash scripts/dist_train_trainval_vitb_fpn.sh
# =============================================================================
